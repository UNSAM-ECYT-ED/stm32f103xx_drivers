...
/*! Declare a pointer to a struct that maps the SYSTICK and NVIC registers. */
typedef struct {
...
extern volatile _CTX * const CTX; /*! Pointer to access to NVIC or SYSTIC regs. */
extern volatile _DEVMAP * const DEVMAP; /*! Pointer to access to MCU devices regs. */
